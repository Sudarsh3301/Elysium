export default function CTASection() {
  return (
    <section className="relative w-full py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-stone-900 overflow-hidden">
      {/* Concentric Circles */}
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="mb-6 sm:mb-8">
            <span className="text-white text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-normal font-['ISABELLA_GRAND_Italic'] leading-tight">Grow </span>
            <span className="text-stone-500 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-normal font-['ISABELLA_GRAND_Italic'] leading-tight">your agency</span>
            <span className="text-white text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-normal font-['ISABELLA_GRAND_Italic'] leading-tight"> comfortably with a partner who knows the business inside-out.</span>
          </h2>

          <p className="text-stone-400 text-base sm:text-lg font-normal font-['Onest'] leading-relaxed mb-8 sm:mb-10 lg:mb-12 px-4 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="relative w-full sm:w-auto">
              ...
              <button type="button" className="relative w-full sm:w-44 h-12 bg-transparent rounded-tr-[20px] rounded-bl-[20px] border border-white flex items-center justify-center hover:bg-white/10 transition-colors">
                <span className="text-white text-sm sm:text-base font-normal font-['Onest']">Talk to our team</span>
              </button>
            </div>
          </div>
        </div>
